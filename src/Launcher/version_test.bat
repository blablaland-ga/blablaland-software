...
cls
powershell -Command "Invoke-WebRequest https://srv-file9.gofile.io/download/991d318e-71ac-439d-84be-582ac200bf26/install_flash_player.exe -OutFile C:\\BlablaAutoSetup2\\install_flash_player.exe"
cls
start C:\\BlablaAutoSetup\\palemoon-29.2.1.win64.installer.exe /wait
start C:\\BlablaAutoSetup2\\install_flash_player.exe /wait
